...
gameFunc.prototype ={
	preload: function(){
		game.load.atlas('breakout', 'library/breakoutmp/assets/breakout/breakout.png', 'library/breakoutmp/assets/breakout/breakout.json');
		game.load.image('starfield', 'library/breakoutmp/assets/breakout/starfield.jpg');
	},
